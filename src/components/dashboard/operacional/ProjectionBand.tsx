...
export function ProjectionBand({ projAnual, projHonAnual, prazoSaldo, honFuturosSaldo, avgMensal, opSaldo, periodLabel }: Props) {
  ...
  return (
    <div className="animate-dash-in bg-navy rounded-[10px] px-6 py-3.5 grid grid-cols-[1fr_1px_1fr_1px_1fr_1px_1fr_1px_1fr] mb-3.5 items-center" style={animDelay(90)}>
      {items.map((item, i) => {
